...
<h2>
	<?php
	$before = apply_filters( 'wcvendors_order_number_link_in_email_template_before', $before = '' );
	$after 	= apply_filters( 'wcvendors_order_number_link_in_email_template_after', $after = '' );
