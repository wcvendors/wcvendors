<?php
/**
 * The template for displaying the vendor registration form on the WooCommerce registration for.
 *
...
<p>
	<label for="apply_for_vendor">
		...
		<?php
		/* translators: %1$s: become a vendor label, %2$s: the vendor label. */
		echo apply_filters( 'wcvendors_vendor_registration_checkbox', sprintf( __( 'Apply to %1$s %2$s? ', 'wc-vendors' ), $become_a_vendor_label, wcv_get_vendor_name( true, false ) ) );
		?>
	</label>
	<br/>
</p>
