<?php
/**
 * Defines the class to notify a customer about a shiped order
 *
 * @version     3.0.0
 * @since       3.0.0
 * @package     WC_Vendors
...
if ( ! class_exists( 'CustomerNotifyShipped' ) ) :
	 ...
	 *
	 * @class       CustomerNotifyShipped
	 * @version     3.0.0
	 * @extends     WC_Email
	 */
	class CustomerNotifyShipped extends WC_Email {
