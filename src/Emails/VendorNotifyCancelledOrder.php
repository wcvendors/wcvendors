<?php
/**
 * Defines the class to notify vendor when an order is canceled
 *
 * @version     3.0.0
 * @since       3.0.0
 * @package     WC_Vendors
...
if ( ! class_exists( 'VendorNotifyCancelledOrder' ) ) :
	 ...
	 *
	 * @class       VendorNotifyCancelledOrder
	 * @version     3.0.0
	 * @author      WC Vendors
	 * @extends     WC_Email
	 */
	class VendorNotifyCancelledOrder extends WC_Email {
