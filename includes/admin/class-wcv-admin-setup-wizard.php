...
class WCVendors_Admin_Setup_Wizard {
	...
	public function setup_wizard() {
		...
		wp_enqueue_style( 'wcv-setup', WCVendors()->plugin_url() . '/assets/css/wcv-setup.css', array( 'dashicons', 'install' ), WCV_VERSION );
		wp_register_script( 'wcv-setup', WCVendors()->plugin_url() . '/assets/js/admin/wcv-setup' . $suffix . '.js', array( 'jquery', 'wc-enhanced-select', 'jquery-blockui', 'wp-util' ), WCV_VERSION );
